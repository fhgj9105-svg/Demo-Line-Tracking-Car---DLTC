...
Future aims:<br>
*Apply smart PID<br>
            *Run in high speed<br>
            *Auto turn PID so that you just need to let your car run on a straing line it will find out Kp, Ki, Kd automatically.<br>
...
Mục tiêu trong tương lai:<br>
*Áp dụng PID thông minh<br>
*Chạy ở tốc độ cao<br>
*Tự động tinh chỉnh PID để bạn chỉ cần cho xe chạy trên đường thẳng, hệ thống sẽ tự động tìm ra các hệ số Kp, Ki, Kd.<br>
